...
def load_llm(huggingface_repo_id, HF_TOKEN):
    os.environ["HUGGINGFACEHUB_API_TOKEN"] = HF_TOKEN  # ✅ Set token as env var
    llm = HuggingFaceEndpoint(
        repo_id=huggingface_repo_id,
        task="text-generation",  # ✅ Specify the correct task
        temperature=0.5,
        max_length=512,  # ✅ This is the correct arg instead of max_new_tokens
        # model_kwargs={
        #     "max_new_tokens": 512  # ✅ This is the correct arg instead of max_length
        # }
    )
    return llm
...
def main():
    st.title("Ask about Assessments!")
